        ...
        <Card v-for="expert in experts" :key="expert.id" class="user-card">
          <div class="user-card-content">
            <div class="user-image-container">
              <img :src="expert.profile_image" class="user-image" alt="User Image">
            </div>
            <div class="user-info">
              <div class="user-name">{{ expert.name }}</div>
              <div class="user-profession">{{ expert.profession }}</div>
  ...
  methods: {
    getRecommendedExperts() {
      ...
      userApiService.getSources().then((response) => {
        this.experts = response.data.user_info.experts;
      });
    },
  },
}
